        ...
        <Element name='home'>
            <div className="min-h-screen relative">
                ...
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full px-5 lg:px-0 lg:max-w-screen-lg'>
                    <div className='block border-2 border-primary bg-white/10 z-10 py-2 px-4 rounded-md text-sm lg:text-lg mt-18 lg:mt-0 text-white w-fit mx-auto text-center'>
                    ...
                    <div className='flex flex-col sm:flex-row justify-center sm:items-center mt-20 gap-4 items-stretch'>
                        <a href='mailto:contact@portalmastersolutions.com' className='text-center sm:text-start py-2 px-4 text-white bg-primary border-2 border-primary rounded-md hover:bg-primary/30 cursor-pointer ease-in-out duration-200'>{t("Започните сада", "hero_btn_1")}</a>
                        <Link to='about'
                            smooth={true}
                            spy={true}
                            duration={500}
                            className='text-center sm:text-start py-2 px-4 text-white bg-transparent border-2 border-white rounded-md hover:bg-white/30 cursor-pointer ease-in-out duration-200'>{t("Сазнајте више", "hero_btn_2")} <FontAwesomeIcon icon={faArrowRight} className='ms-2' /></Link>
                    </div>
                </div>
            </div>
        </Element>);
