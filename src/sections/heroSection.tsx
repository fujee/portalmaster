        ...
        <Element name='home'>
            <div className="min-h-screen relative">
                ...
                <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-screen-md'>
                    ...
                    <p className='text-white text-center mt-10'>{t("Портал Мастер је платформа која омогућава једноставну израду и управљање порталима прилагођеним специфичним потребама корисника. Без обзира да ли се ради о образовним институцијама (школе, вртићи, универзитети, факултети), јавним установама, локалним самоуправама или организацијама у другим секторима, наша платформа пружа сигурна, централизована и прилагодљива решења која омогућавају ефикасно управљање, дигитализацију процеса и унапређење рада организација.")}</p>
