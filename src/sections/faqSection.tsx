                    ...
                    <div className="mt-10">
                        <Disclosure as='div' className="py-5 border-b-2 border-secondary dark:border-white/80">
                            <DisclosureButton
                                ...
                                <h6 className="text-2xl font-semibold text-black dark:text-white">{t("Шта је Портал Мастер и како функционише?")}</h6>
                        ...
                        <Disclosure as='div' className="py-5 border-b-2 border-secondary dark:border-white/80">
                            <DisclosureButton
                                as="div"
                                className="w-full flex justify-between cursor-pointer group pb-2">
                                <h6 className="text-2xl font-semibold text-black dark:text-white">{t("Да ли је потребно техничко предзнање за коришћење платформе?")}</h6>
                                <FontAwesomeIcon icon={faPlusCircle} className="text-primary text-2xl block group-data-[open]:hidden" />
                                <FontAwesomeIcon icon={faMinusCircle} className="text-secondary dark:text-white text-2xl hidden group-data-[open]:block" />
                            </DisclosureButton>
                            <div className="overflow-hidden py-2">
                        ...
                        <Disclosure as='div' className="py-5 border-b-2 border-secondary dark:border-white/80">
                            <DisclosureButton
                                as="div"
                                className="w-full flex justify-between cursor-pointer group pb-2">
                                <h6 className="text-2xl font-semibold text-black dark:text-white">{t("Може ли се платформа прилагодити специфичним потребама организације?")}</h6>
                                <FontAwesomeIcon icon={faPlusCircle} className="text-primary text-2xl block group-data-[open]:hidden" />
                                <FontAwesomeIcon icon={faMinusCircle} className="text-secondary dark:text-white text-2xl hidden group-data-[open]:block" />
                            </DisclosureButton>
                            <div className="overflow-hidden py-2">
                        ...
                        <Disclosure as='div' className="py-5 border-b-2 border-secondary dark:border-white/80">
                            <DisclosureButton
                                as="div"
                                className="w-full flex justify-between cursor-pointer group pb-2">
                                <h6 className="text-2xl font-semibold text-black dark:text-white">{t("Како се ажурирају портали?")}</h6>
                                <FontAwesomeIcon icon={faPlusCircle} className="text-primary text-2xl block group-data-[open]:hidden" />
                                <FontAwesomeIcon icon={faMinusCircle} className="text-secondary dark:text-white text-2xl hidden group-data-[open]:block" />
                            </DisclosureButton>
                            <div className="overflow-hidden py-2">
                        ...
                        <Disclosure as='div' className="py-5 border-b-2 border-secondary dark:border-white/80">
                            <DisclosureButton
                                as="div"
                                className="w-full flex justify-between cursor-pointer group pb-2">
                                <h6 className="text-2xl font-semibold text-black dark:text-white">{t("Да ли је могућа интеграција са постојећим системима?")}</h6>
                                <FontAwesomeIcon icon={faPlusCircle} className="text-primary text-2xl block group-data-[open]:hidden" />
                                <FontAwesomeIcon icon={faMinusCircle} className="text-secondary dark:text-white text-2xl hidden group-data-[open]:block" />
                            </DisclosureButton>
                            <div className="overflow-hidden py-2">
                        ...
                        <Disclosure as='div' className="py-5 border-b-2 border-secondary dark:border-white/80">
                            <DisclosureButton
                                as="div"
                                className="w-full flex justify-between cursor-pointer group pb-2">
                                <h6 className="text-2xl font-semibold text-black dark:text-white">{t("Како се гарантује сигурност података на платформи?")}</h6>
                                <FontAwesomeIcon icon={faPlusCircle} className="text-primary text-2xl block group-data-[open]:hidden" />
                                <FontAwesomeIcon icon={faMinusCircle} className="text-secondary dark:text-white text-2xl hidden group-data-[open]:block" />
                            </DisclosureButton>
                            <div className="overflow-hidden py-2">
                        ...
                        <Disclosure as='div' className="py-5 border-b-2 border-secondary dark:border-white/80">
                            <DisclosureButton
                                as="div"
                                className="w-full flex justify-between cursor-pointer group pb-2">
                                <h6 className="text-2xl font-semibold text-black dark:text-white">{t("Која врста подршке је доступна корисницима?")}</h6>
                                <FontAwesomeIcon icon={faPlusCircle} className="text-primary text-2xl block group-data-[open]:hidden" />
                                <FontAwesomeIcon icon={faMinusCircle} className="text-secondary dark:text-white text-2xl hidden group-data-[open]:block" />
                            </DisclosureButton>
                            <div className="overflow-hidden py-2">
                        ...
                        <Disclosure as='div' className="py-5 border-b-2 border-secondary dark:border-white/80">
                            <DisclosureButton
                                as="div"
                                className="w-full flex justify-between cursor-pointer group pb-2">
                                <h6 className="text-2xl font-semibold text-black dark:text-white">{t("Да ли су хостинг и домени део решења")}</h6>
                                <FontAwesomeIcon icon={faPlusCircle} className="text-primary text-2xl block group-data-[open]:hidden" />
                                <FontAwesomeIcon icon={faMinusCircle} className="text-secondary dark:text-white text-2xl hidden group-data-[open]:block" />
                            </DisclosureButton>
                            <div className="overflow-hidden py-2">
                        ...
                        <Disclosure as='div' className="py-5">
                            <DisclosureButton
                                as="div"
                                className="w-full flex justify-between cursor-pointer group pb-2">
                                <h6 className="text-2xl font-semibold text-black dark:text-white">{t("Како могу да добијем додатне информације о платформи?")}</h6>
                                <FontAwesomeIcon icon={faPlusCircle} className="text-primary text-2xl block group-data-[open]:hidden" />
                                <FontAwesomeIcon icon={faMinusCircle} className="text-secondary dark:text-white text-2xl hidden group-data-[open]:block" />
                            </DisclosureButton>
                            <div className="overflow-hidden py-2">
