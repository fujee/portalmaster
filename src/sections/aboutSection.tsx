                ...
                <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-20 mt-10">
                    <div className="">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? kvalitetDark : kvalitet} alt={t('Универзална примена')} className="me-4 w-fit" />
                    ...
                    <div className="">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? kvalitetDark : kvalitet} alt={t('Унапређење корисничког искуства')} className="me-4 w-fit" />
                    ...
                    <div className="">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? securityDark : security} alt={t('Сигурност')} className="me-4 w-fit" />
                    ...
                    <div className="">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? administracijaDark : administracija} alt={t('Јединствена администрација')} className="me-4 w-fit" />
                    ...
                    <div className="">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? analitikaDark : analitika} alt={t('Аналитика за сваку потребу')} className="me-4 w-fit" />
                    ...
                    <div className="">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? kvalitetDark : kvalitet} alt={t('Квалитет и стандардизација')} className="me-4 w-fit" />
