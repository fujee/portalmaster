    ...
    return <Element name='about'>
        <div id="about" className="bg-transparent pt-24 pb-24">
            <div className="container mx-auto px-5 lg:px-0">
                ...
                <h2 className="mt-10 text-2xl lg:text-4xl font-bold text-black dark:text-white">{t('Технологија која обликује дигиталну будућност', "about_title")}</h2>
                <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-20 mt-10">
                    <div className="group">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? primenaDark : primena} alt={t('Универзална примена', "about_f1_title")} className="me-4 w-fit group-hover:animate-wiggle" />
                            <h3 className="text-lg lg:text-2xl font-semibold text-secondary dark:text-white">{t('Универзална примена', "about_f1_title")}</h3>
                        </div>
                        <div className="mt-5">
                            ...
                            <p className="text-black/80 dark:text-white/80">{t('Портал Мастер омогућава централизовано креирање и управљање великим бројем портала. Компаније или друге организације могу брзо и лако покренути појединачне портале за продавнице, локалне канцеларије, школе, факултете, општине или друге институције.', "about_f1_desc_1")}</p>
                        </div>
                        <div className="mt-5">
                            ...
                            <p className="text-black/80 dark:text-white/80">{t('У оквиру Портал Мастер решења, укључени су и трошкови хостинга за све портале, чиме се елиминишу додатни оперативни издаци за организацију. Поред тога, корисницима који не желе да користе сопствене домене, нудимо могућност креирања поддомена за сваки специфични портал.', "about_f1_desc_2")}</p>
                        </div>
                    </div>
                    <div className="group">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? iskustvoDark : iskustvo} alt={t('Унапређење корисничког искуства', "about_f2_title")} className="me-4 w-fit group-hover:animate-wiggle" />
                            <h3 className="text-lg lg:text-2xl font-semibold text-secondary dark:text-white">{t('Унапређење корисничког искуства', "about_f2_title")}</h3>
                        </div>
                        <div className="mt-5">
                        ...
                        <div className="mt-5">
                            <h5 className="text-primary font-semibold"><FontAwesomeIcon icon={faCheck} className="me-2" />{t("Прилагођеност различитим секторима", "about_f2_subtitle_3")}</h5>
                            <p className="text-black/80 dark:text-white/80">{t('Без обзира на то да ли је у питању образовна институција, локална самоуправа или организација из приватног сектора, Портал Мастер нуди функционалности прилагођене специфичним захтевима корисника.', "about_f2_desc_3")}</p>
                        </div>
                    </div>
                    <div className="group">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                        ...
                        <div className="mt-5">
                            <h5 className="text-primary font-semibold"><FontAwesomeIcon icon={faCheck} className="me-2" />{t("Централизовано управљање налозима", "about_f3_subtitle_1")}</h5>
                            <p className="text-black/80 dark:text-white/80">{t('Сви налози, подаци и активности су под строгом контролом, чиме се обезбеђује висок ниво сигурности у раду.', "about_f3_desc_1")}</p>
                        </div>
                        <div className="mt-5">
                            ...
                            <p className="text-black/80 dark:text-white/80">{t('Платформа се може интегрисати са постојећим сервисима за ауторизацију, чиме се обезбеђује додатна заштита података и минимизирају ризици од неовлашћеног приступа.', "about_f3_desc_2")}</p>
                        </div>
                        <div className="mt-5">
                            <h5 className="text-primary font-semibold"><FontAwesomeIcon icon={faCheck} className="me-2" />{t("Непрекидно унапређивање сигурности", "about_f3_subtitle_3")}</h5>
                    ...
                    <div className="group">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? administracijaDark : administracija} alt={t('Јединствена администрација', "about_f4_title")} className="me-4 w-fit group-hover:animate-wiggle" />
                            <h3 className="text-lg lg:text-2xl font-semibold text-secondary dark:text-white">{t('Јединствена администрација', "about_f4_title")}</h3>
                        </div>
                        <div className="mt-5">
                            ...
                            <p className="text-black/80 dark:text-white/80">{t('Управљање садржајем, структурама и корисничким правима кроз један интерфејс, уз могућност да сваки портал буде прилагођен специфичним потребама корисника.', "about_f4_desc_1")}</p>
                        </div>
                        <div className="mt-5">
                            ...
                            <p className="text-black/80 dark:text-white/80">{t('Сви портали се аутоматски ажурирају најновијим функционалностима, без потребе за додатним техничким прилагођавањима или интервенцијама.', "about_f4_desc_2")}</p>
                        </div>
                        <div className="mt-5">
                            <h5 className="text-primary font-semibold"><FontAwesomeIcon icon={faCheck} className="me-2" />{t("Лако управљање страницама и компонентама", "about_f4_subtitle_3")}</h5>
                    ...
                    <div className="group">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                            <img src={theme === DARK_THEME ? analitikaDark : analitika} alt={t('Аналитика за сваку потребу', "about_f5_title")} className="me-4 w-fit group-hover:animate-wiggle" />
                            <h3 className="text-lg lg:text-2xl font-semibold text-secondary dark:text-white">{t('Аналитика за сваку потребу', "about_f5_title")}</h3>
                        </div>
                        <div className="mt-5">
                        ...
                        <div className="mt-5">
                            ...
                            <p className="text-black/80 dark:text-white/80">{t('Интегрисани аналитички алати омогућавају доношење стратешких одлука заснованих на подацима, попут оптимизације и ефикасније организације садржаја.', "about_f5_desc_2")}</p>
                        </div>
                    </div>
                    <div className="group">
                        <div className="flex flex-col lg:flex-row justify-start lg:items-center">
                        ...
                        <div className="mt-5">
                            ...
                            <p className="text-black/80 dark:text-white/80">{t('Креирање визуелно уједначених и професионално дизајнираних портала, са могућностима прилагођавања бренду и специфичним захтевима организације.', "about_f6_desc_1")}</p>
                        </div>
                        <div className="mt-5">
                            <h5 className="text-primary font-semibold"><FontAwesomeIcon icon={faCheck} className="me-2" />{t("Високи стандарди приступачности", "about_f6_subtitle_2")}</h5>
