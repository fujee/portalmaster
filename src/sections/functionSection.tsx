        ...
        <div className="py-24">
            <div className="container mx-auto px-5 lg:px-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-8 lg:grid-rows-4 gap-6 mt-20">
                    <div className="lg:col-span-5 lg:row-span-1 border-2 rounded-xl lg:h-[440px] border-navBorder dark:border-navBorderDark bg-pureWhite bg-custom_bg1 dark:bg-pureBlack dark:bg-custom_bg1_dark p-10 flex flex-col">
                        ...
                        <div className="flex-grow relative overflow-hidden mt-4">
                            <img src={theme === LIGHT_THEME ? feature1 : feature1Dark} alt={t("Интегрисан CRM систем", "func_1_title")} className="w-full h-full object-contain" />
                        </div>
                    </div>

                    <div className="border-2 rounded-xl h-[440px] border-navBorder dark:border-navBorderDark p-10 bg-pureWhite dark:bg-pureBlack lg:col-span-3 lg:row-span-1 flex flex-col">
                        <div className="flex-grow-0">
                        ...
                        <div className="flex-grow relative overflow-hidden mt-4">
                            <img src={theme === LIGHT_THEME ? feature2 : feature2Dark} alt={t("Ефикасна дистрибуција материјала", "func_2_title")} className="w-full h-full object-contain" />
                        </div>
                    </div>

                    <div className="border-2 rounded-xl h-[440px] border-navBorder dark:border-navBorderDark p-10 lg:col-span-4 lg:row-span-1 bg-pureWhite bg-custom_bg2 dark:bg-pureBlack dark:bg-custom_bg2_dark flex flex-col">
                        <div className="flex-grow-0">
                        ...
                        <div className="flex-grow relative overflow-hidden mt-4">
                            <img src={theme === LIGHT_THEME ? feature3 : feature3Dark} alt={t("Централизовано одржавање садржаја")} className="w-full h-full object-contain" />
                        </div>
                    </div>


                    <div className="border-2 rounded-xl h-[440px] border-navBorder dark:border-navBorderDark p-10 lg:col-span-4 lg:row-span-1 bg-pureWhite bg-custom_bg3 dark:bg-pureBlack dark:bg-custom_bg3_dark bg-no-repeat flex flex-col">
                        <div className="flex-grow-0">
                        ...
                        <div className="flex-grow relative overflow-hidden mt-4">
                            <img src={theme === LIGHT_THEME ? feature4 : feature4Dark} alt={t("Централизовано одржавање садржаја")} className="w-full h-full object-contain" />
                        </div>
                    </div>


                    <div className="border-2 rounded-xl h-[440px] border-navBorder dark:border-navBorderDark p-10 lg:col-span-3 lg:row-span-1 bg-pureWhite dark:bg-pureBlack bg-custom_bg6 dark:bg-custom_bg6_dark bg-no-repeat flex flex-col">
                        <div className="flex-grow-0">
                        ...
                        <div className="flex-grow relative overflow-hidden mt-4">
                            <img src={theme === LIGHT_THEME ? feature5 : feature5Dark} alt={t("Централизовано одржавање садржаја")} className="w-full h-full object-contain" />
                        </div>
                    </div>

                    <div className="border-2 rounded-xl h-[440px] border-navBorder dark:border-navBorderDark p-10 lg:col-span-5 lg:row-span-1 bg-pureWhite bg-custom_bg4 dark:bg-pureBlack dark:bg-custom_bg4_dark flex flex-col">
                        <div className="flex-grow-0">
                        ...
                        <div className="flex-grow relative overflow-hidden mt-4">
                            <img src={theme === LIGHT_THEME ? feature6 : feature6Dark} alt={t("Централизовано одржавање садржаја")} className="w-full h-full object-contain" />
                        </div>
                    </div>

                    <div className="border-2 rounded-xl h-[440px] border-navBorder dark:border-navBorderDark p-10 lg:col-span-4 lg:row-span-1 bg-custom_bg5 dark:bg-pureBlack dark:bg-custom_bg5_dark flex flex-col">
                        <div className="flex-grow-0">
                        ...
                        <div className="flex-grow relative overflow-hidden mt-4">
                            <img src={theme === LIGHT_THEME ? feature7 : feature7Dark} alt={t("Ефикасна дистрибуција материјала", "func_2_title")} className="w-full h-full object-contain" />
                        </div>
                    </div>
